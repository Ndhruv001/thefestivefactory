 ...
 * ----------------------
 * Site-wide footer with logo, quick links, contact info, and social links.
 * Uses SITE_CONFIG and NAV_LINKS constants.
 */
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            <img src={logo} alt={SITE_CONFIG.name} className="h-10 w-auto mb-4" />
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-[#F9FAFB] font-semibold mb-4 text-sm tracking-wide">Quick Links</h4>
            <ul className="space-y-2.5">
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
                  <Link
                    to={link.href}
                    className="text-[#9CA3AF] hover:text-[#66E3E3] text-sm transition-colors duration-200"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-[#F9FAFB] font-semibold mb-4 text-sm tracking-wide">Contact</h4>
            <ul className="space-y-3 text-sm text-[#9CA3AF]">
              ...
              <li className="flex items-center gap-2">
                <span>🕐</span> {SITE_CONFIG.businessHours}
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-[#6B7280] text-xs italic">
            "Crafting Celebrations That People Remember"
          </p>
        </div>
      </div>
    </footer>
